...
#ifdef REMOTE_AI
/* To use in ai.c and main.c where remote AI is interacted with */
#define AIR_CURRENT	1000
#define AIR_UNUSED	0

enum {AIR_VERSION = '9', AIR_PLAYER = '8', AIR_EVENT = '7', AIR_SCORE = '6', AIR_EOT = '5', AIR_QUIT = '0'};
#endif /* REMOTE_AI */
